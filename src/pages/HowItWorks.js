        ...
        <div className="my-5">
                ...
                <Container>
                    <Row className="align-items-center justify-content-center">
                        <Col md={6} sm={12}>
                            ...
                            <Button variant="primary" className="font-weight-bold mt-5">
                                <h5 className="p-2 m-0">View Our Plans</h5>
                            </Button>
                        </Col>
                        <Col md={4} sm={12}>
                            <img src={Hiw_Banner} alt="Hiw_Banner" className="w-100 h-100"/>
                        </Col>
                    </Row>
                </Container>
            </section>
            <section className="py-5">
                <Container>
                    ...
                    <Row className="justify-content-center">
                        <Col>
                            <img src={Hdiw} alt="HOW DOES IT WORK" className="w-100 d-none d-sm-none d-md-block"/>
                            <img src={Hiw_v} alt="HOW DOES IT WORK" className="w-100 d-block d-sm-block d-md-none"/>
                        </Col>
                    </Row>
                </Container>
            </section>
            <section className="py-5">
                <Container>
                    ...
                    <Row className="justify-content-center">
                        <Col sm={12} md={4}>
                            <img src={P1} alt="HOW DOES IT WORK" className="w-100"/>
                        </Col>
                        <Col sm={12} md={4}>
                            <img src={P2} alt="HOW DOES IT WORK" className="w-100"/>
                        </Col>
                        <Col sm={12} md={4}>
                            <img src={P3} alt="HOW DOES IT WORK" className="w-100"/>
                        </Col>
                    </Row>
                </Container>
            </section>
